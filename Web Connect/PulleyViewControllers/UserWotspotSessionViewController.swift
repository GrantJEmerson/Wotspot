//
//  UserWotspotSessionViewController.swift
//  Wotspot
//
...
class UserWotspotSessionViewController: PulleyViewController {
    ...
    private func presentDisconnectedAlert() {
        let alertController = CustomAlertController(title: "Disconnected",
                                      message: "You have been removed from the current Wotspot session.",
...
extension UserWotspotSessionViewController: MCSessionDelegate {
...
extension UserWotspotSessionViewController: ContentDelegate, ParentDelegate {
